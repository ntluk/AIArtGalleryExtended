...
namespace MMH
{
    public class Avatar : Streamable
    {
        ...
        // list of joint pools
        public Dictionary<Joint.JointName, Joint> jointPool;
        ...
        public void Update()
        {
            ...
            //test.transform.position = jointPool[Joint.JointName.HAND_L].getTransform().position;
            //test2.transform.position = jointPool[Joint.JointName.HAND_R].getTransform().position;
        }
        ...
        public Joint GetJointData(Joint.JointName jointType, Animator animator)
        {
        ...
        public static SkeletonBone GetSkeletonBone(Animator animator, string boneName) => animator.avatar.humanDescription.skeleton.First(sb => sb.name == boneName);
        ...
        public HumanBodyBones MapKinectJoint(Joint.JointName joint)
        {
